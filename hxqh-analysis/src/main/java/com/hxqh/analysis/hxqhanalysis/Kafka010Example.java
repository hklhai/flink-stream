...
package com.hxqh.analysis.hxqhanalysis;
 ...
 * kafka-topics.sh --create --zookeeper=127.0.0.1:2181 --partitions 1 --replication-factor 1 --topic test2
 * kafka-topics.sh --create --zookeeper=127.0.0.1:2181 --partitions 1 --replication-factor 1 --topic test4
 * kafka-topics.sh --delete --zookeeper=127.0.0.1:2181 --topic test3
 * <p>
 * <p>
